...
class Recipe(models.Model):
    ...
    prep_time = models.PositiveIntegerField(blank=True, null=True, default=None)
    cook_time = models.PositiveIntegerField(blank=True, null=True, default=None)
    total_time = models.PositiveIntegerField(blank=True, null=True, default=None)
    servings = models.PositiveIntegerField(blank=True, null=True, default=None)
